...
# Memory: VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
MEM_1 := Computer_System_VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
$(MEM_1)_NAME := VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
...
$(MEM_1)_START := 0x09000000
$(MEM_1)_END := 0x09001fff
$(MEM_1)_SPAN := 0x00002000
$(MEM_1)_HIERARCHICAL_PATH := VGA_Subsystem.Char_Buf_Subsystem.Onchip_SRAM
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM
VGA_Subsystem_Char_Buf_Subsystem_Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
