...
SOPCINFO_FILE := /opt/intelFPGA/20.1.1/University_Program/Computer_Systems/DE2-115/DE2-115_Computer/verilog/Computer_System.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Computer_System
SOPC_NAME := Computer_System
...
# setting SOPC_SYSID_BASE_ADDRESS is 0xff202040
SOPC_SYSID_FLAG += --sidp=0xff202040
ELF_PATCH_FLAG  += --sidp 0xff202040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1555017408
SOPC_SYSID_FLAG += --timestamp=1555017408
ELF_PATCH_FLAG  += --timestamp 1555017408
